...
Route::middleware(['auth', 'role:admin'])
    ...
    Route::prefix('jasa')->group(function () {
        ...
        Route::post('/{id}/approve', [JasaController::class, 'approve'])->name('admin.jasa.approve');
...
Route::middleware(['auth', 'role:pekerja'])
    ...
    Route::middleware(['verified.worker'])
        ...
        Route::post('/orders/{id}/finish', [OrderController::class, 'workerFinish'])->name('pekerja.orders.finish');
    });
});
...
Route::middleware(['auth', 'role:pekerja'])
    ...
    ->name('worker.')
    ->group(function () {
        Route::get('/saldo', [WorkerBalanceController::class, 'index'])->name('saldo');
        Route::post('/saldo/withdraw', [WorkerBalanceController::class, 'withdraw'])->name('saldo.withdraw');
});
